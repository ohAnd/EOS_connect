...
_ALL_FIELDS: list[FieldDef] = [
    ...
    FieldDef(
        ...
        section="price",
        level="standard",
        description="Market zone for energy forecast",
        labels=["experimental"],
        help_url="configuration.html#energyforecast",
    ...
    FieldDef(
        ...
        validation={"choices": [
            "fronius_gen24", "fronius_gen24_legacy", "victron", "evcc", "default"
        ]},
    ...
    FieldDef(
        ...
        labels=["restart_required"],
        help_url="configuration.html#mqtt",
        depends_on={"mqtt.ha_mqtt_auto_discovery": [True]},
        display_group="Home Assistant",
    ),
