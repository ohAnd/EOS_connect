...
_ALL_FIELDS: list[FieldDef] = [
    ...
    FieldDef(
        ...
        section="eos",
        level="expert",
        description="Maximum grid import power in Watts (0 = no limit). Use for grid connection limits.",
        help_url="configuration.html#eos",
    ...
    FieldDef(
        ...
        section="eos",
        level="expert",
        description="Maximum grid export power in Watts (0 = no limit). Use for grid feed-in limits.",
        help_url="configuration.html#eos",
        validation={"min": 0, "max": 100000},
        depends_on={"eos.source": "local_evopt"},
        display_group="Local Optimizer",
