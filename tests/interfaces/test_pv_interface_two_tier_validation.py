...
def incomplete_victron_no_api_key():
    ...
    config_source = {"source": "victron"}  # Missing: api_key
    config = [
        {"name": "System", "lat": 51.5, "lon": 10.0, "resource_id": "vrm-123"}
    ]
    return config_source, config
...
def incomplete_solcast_config():
    ...
    config_source = {"source": "solcast"}  # Missing: api_key
    config = [{"name": "System", "resource_id": "123456"}]
    return config_source, config
...
def valid_victron_config():
    ...
    config_source = {"source": "victron", "api_key": "test-key"}
    config = [{"name": "System", "resource_id": "vrm-123", "lat": 51.5, "lon": 10.0}]
    return config_source, config
...
def valid_solcast_config():
    ...
    config_source = {"source": "solcast", "api_key": "test-key"}
    config = [{"name": "System", "resource_id": "123456", "lat": 51.5, "lon": 10.0}]
    return config_source, config
